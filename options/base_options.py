...
class BaseOptions:
    ...
    def initialize(self, parser):
        ...
        # basic parameters
        parser.add_argument("--dataroot", default="datasets/apple2orange", required=True, help="path to images (should have subfolders trainA, trainB, valA, valB, etc)")
        parser.add_argument("--name", type=str, default="apple2orange", help="name of the experiment. It decides where to store samples and models")
        ...
        parser.add_argument("--preprocess", type=str, default="rescale_shortside", help="scaling and cropping of images at load time [resize_and_crop | crop | scale_width | scale_width_and_crop | rescale_shortside | none]")
