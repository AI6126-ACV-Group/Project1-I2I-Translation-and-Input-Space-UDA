...
if __name__ == "__main__":
    ...
    #CHECKPOINT = './checkpoints/art2realworld_cyCADA_128/latest_net_G_A.pth'
    #DEST_DIR = './transformed_dataset/cyCADA/art2realword'

    SRC_DIR = './original_datasets/PACS/photo'
    CHECKPOINT = './checkpoints/photo2sketch_cyCADA_128/latest_net_G_A.pth'
    DEST_DIR = './transformed_dataset/cyCADA/photo2sketch'
