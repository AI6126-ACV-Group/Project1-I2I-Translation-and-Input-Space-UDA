...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Train translated-source ResNet-18 baseline for Office-31 Amazon2Webcam."
    )
    parser.add_argument("--translated-root", type=str, required=True)
    parser.add_argument("--split-dir", type=str, required=True)
    parser.add_argument("--output-dir", type=str, default="./outputs/translated_source/amazon2webcam")
